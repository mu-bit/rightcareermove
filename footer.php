...
?>
		...
		<footer id="colophon" class="site-footer" role="contentinfo">
			...
			<div class="copyright">
				<div class="container">
					<div class="site-info">
						<?php echo apply_filters( 'jobify_footer_copyright', sprintf( __( '&copy; %1$s %2$s &mdash; All Rights Reserved', 'jobify' ), date( 'Y' ), get_bloginfo( 'name' ) ) ); ?></BR>
						Designed And Developed By <a href="https://www.freelancer.com/u/ViruSudha.html">Sudha</a>
					</div><!-- .site-info -->
